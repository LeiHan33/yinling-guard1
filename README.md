...
<p align="center">
  <a href="https://github.com/LeiHan33/yinling-guard1/releases/tag/v1.0.4"><img src="https://img.shields.io/badge/version-v1.0.4-2E7D32?style=flat-square" alt="version"></a>
...
| | |
|---|---|
| **中文** | **[⬇️ 下载 APK v1.0.4](https://github.com/LeiHan33/yinling-guard1/releases/download/v1.0.4/yinling-guard-v1.0.4-debug.apk)** — 修复搜索页误触发，提升识别准确度 |
| **English** | **[⬇️ Download APK v1.0.4](https://github.com/LeiHan33/yinling-guard1/releases/download/v1.0.4/yinling-guard-v1.0.4-debug.apk)** — Fixes search-page false skips, improves matching |
