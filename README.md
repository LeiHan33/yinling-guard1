...
<p align="center">
  <a href="https://github.com/LeiHan33/yinling-guard1/releases/tag/v1.0.3"><img src="https://img.shields.io/badge/version-v1.0.3-2E7D32?style=flat-square" alt="version"></a>
...
| | |
|---|---|
| **中文** | **[⬇️ 下载 APK v1.0.3](https://github.com/LeiHan33/yinling-guard1/releases/download/v1.0.3/yinling-guard-v1.0.3-debug.apk)** — 修复刷视频时屏蔽词不生效 |
| **English** | **[⬇️ Download APK v1.0.3](https://github.com/LeiHan33/yinling-guard1/releases/download/v1.0.3/yinling-guard-v1.0.3-debug.apk)** — Fixes keyword detection during video playback |
